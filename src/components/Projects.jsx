        ...
        >
            {cellData.map((cell, index) => {
                ...
                return (
                    <div
                        key={index}
                        className={`h-full w-full rounded-[1px] ${isContribution ? "animate-highlight" : "bg-[#161b22]"
                            }`}
                        style={{
...
const Projects = () => (
    ...
    >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mb-14">
                <p className="text-xs uppercase tracking-widest font-mono text-orange-500 mb-2">
                    03 / Projects
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {projects.map((project) => (
                    <div
                        key={project.id}
                        className="card-panel card-panel-hover rounded-xl flex flex-col"
                    >
                        <div className="p-6 sm:p-8 flex-1">
                            ...
                            <div className="flex items-start justify-between mb-3">
                                <div>
                                    ...
                                    <p className="text-xs font-mono text-orange-500 mt-0.5 uppercase tracking-wider">
                                        {project.subtitle}
                                    </p>
                                </div>
                            ...
                            <ul className="space-y-2 mb-6">
                                {project.bulletPoints.map((point, index) => (
                                    ...
                                    >
                                        <span className="text-orange-500 shrink-0 mt-0.5 font-bold">
                                            —
                                        </span>
