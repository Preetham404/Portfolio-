...
const Navbar = () => {
    ...
    return (
        <>
            <header
                className={cn(
                    "fixed top-0 left-0 w-full z-50 transition-all duration-300 py-6 px-6 sm:px-10 flex items-center justify-between",
                    scrolled
            ...
            >
                <a
                    ...
                    className="text-lg font-extrabold tracking-tight text-white hover:text-zinc-300 transition-colors"
                >
                    Preetham Shetty
                </a>
